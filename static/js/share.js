...
salesDetail.prototype = 
{
	...
	payInfo: function(scrollTop){
		var that = this, infos = that.orderInfo, html='';

	 html +='<h2 class="m-title">物流和发票信息</h2>' 
	 		+'<div class="item-wrap">'
			+'<ul>'
	...
	remark: function(scrollTop){
		var that = this;
		var html ='<h2 class="m-title">补充条款、备注和附件</h2>'
				 +'<div class="remarks-wrap"><div id="provisions" class="item-wrap clause">'
				 +'	<h2>补充条款：</h2>'
